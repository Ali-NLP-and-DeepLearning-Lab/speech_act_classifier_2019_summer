CURRENT_DIR=$(pwd)
DATA_PATH="${CURRENT_DIR}/data/swda_train_data.csv"
TEST_DATA_PATH="${CURRENT_DIR}/data/swda_val_data.csv"
...
CHECKPOINT_PATH="${CURRENT_DIR}/trained_model/trained_model_SwDA.pth" # put path for checkpoint
